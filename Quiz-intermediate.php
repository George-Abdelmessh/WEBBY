    ...
    if($_SERVER["REQUEST_METHOD"] == "POST"){
        ...
        if(!empty($_POST)){
            ...
            if(!empty($correct) && $correct>3){
                ...
                $sql="UPDATE `users` SET `intermediate_result`='$correct' WHERE  `E-mail`='".$_SESSION["email"]."'";
                ...
                echo "<script>
                alert(' your result is $correct');
                window.location.href='intermediate-course.php';
                </script>";
...
<div class="container-lg  ">
    <h1>Quiz For Intermediate Course</h1>
    <div id="myCarousel" class="carousel slide">
 
        <div class="carousel-inner">
        <form action="Quiz-intermediate.php" method="post">
